...
public class ProxyChain {
	...
	private final Object[] mathodParams;
	...
	public ProxyChain(Class<?> targetClass, Object targetObject, Method targetMethod, MethodProxy methodProxy,
		...
		this.mathodParams = methodParams;
	...
	public Object doProxyChain() throws Throwable{
		...
		if(proxyIndex < proxyList.size()){
			...
			methodResult = methodProxy.invokeSuper(targetObject, mathodParams);
		}
		return methodResult;
	}
